...
let end_gen_implementation ?toplevel prefixname
  ...
  let sexp_string = Sexplib0.Sexp.to_string (Sexplib0.Sexp_conv.sexp_of_triple
    ...
    (Sexplib0.Sexp_conv.sexp_of_list Clambda_frontend.Clambda_types.sexp_of_preallocated_block)
    (Sexplib0.Sexp_conv.sexp_of_list Clambda_frontend.Clambda_types.sexp_of_preallocated_constant)
    clambda)
  in
